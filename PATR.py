# Timothy Swallow
# 08/06/2021
# turtle-drawing ~ Petals around the Rose
...
def main():
    ...
    while True:
        ...
        if rules == "y":
            ...
            print("""
             @}>---}--------                                                               --------(---<{@
                                        According to Henry Gilroy's report
                   The founders of Microsoft, Bill Gates and Paul Allen, were amongst those
                  heading home to Albuquerque from the National Computer Conference in Dallas
                     when Bill was introduced to the game for the first time. It took him
                               his entire flight back but he eventually cought on.
            Mark James, the Seer of Comex at USC (who gave us the game in the first place), observed that
                          many brilliant, learned folk who visit their establishment and
                        subject themselves to this, depart hours later without the answer.
                          Many draw sketches of the throws and carry the sketches off to
                     laboratories for study among the boiling cauldrons and croaking ravens.
                                 Weeks later, they may call Comex with proposed
                    answers based on elaborate (and expensive) computer analyses of the game.
                                The answers proposed are more often wrong than right.
                Petals Around the Rose may be almost as great a drag on the national economy as Star Trek.
                            ~September/October 1977 edition of Personal Computing magazine
             @}>---}--------                                                                --------(---<{@
                    \n""")
            break
        elif rules == "n":
